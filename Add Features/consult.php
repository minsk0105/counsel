...
<body>
    ...
    <section class="main" id="main">
        <form action="consult_process.php#main" method="post">
            <div class="consult_container">
                ...
                <div class="counsel-submit_button">
                    ...
                    <div class="non-members-order_modal">
                        <div class="non-members-order_modal-box">
                            <i class="fa-solid fa-xmark" id="remove-non-members"></i>
                            <p>비회원으로 신청하시겠습니까?</p>

                            <div class="non-members_submit">
                                <button type="button" id="non-members-cancel">취소</button>
                                <input type="submit" value="확인" id="insert_button">
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <div class="modal">
        ...
        <div class="modal_box">
            ...
            <!-- 사용자 정보 입력 폼 -->
            <form action="counsel_view.php" method="post" id="list_view">
                <div class="input_user-info">
                    <span>성명 :</span>
                    <input type="text" name="name" placeholder="성명" id="view-name">
                </div>

                <div class="input_user-info">
                    <span>전화 번호 :</span>
                    <input type="text" name="phone" placeholder="전화 번호 (01012345678)" id="view-phone">
                </div>
                ...
                <div class="app-submit">
                    ...
                    <input type="submit" value="다음" id="view-submit">
                </div>
            </form>
        </div>
